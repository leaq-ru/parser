...
`)
	...
	for i := 0; i < b.N; i += 1 {
		(&Company{}).digHTML(context.Background(), dress4carHTML)
	}
}
...
`)
	...
	expected := &Company{
		Title:       "Авточехлы из экокожи, каркасные авточехлы в Ниж",
	...
	actual := &Company{}
	actual.digHTML(context.Background(), dress4carHTML)
...
`)
	...
	actual := &Company{}
	actual.digHTML(context.Background(), alarmSuzukiHTML)
...
<p>© Горсправка 2009-2019</p>
	...
	actual := &Company{}
	actual.digHTML(context.Background(), news050ruHTML)
